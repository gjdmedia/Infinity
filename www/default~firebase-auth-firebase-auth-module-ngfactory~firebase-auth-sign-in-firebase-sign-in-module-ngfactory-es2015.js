(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~firebase-auth-firebase-auth-module-ngfactory~firebase-auth-sign-in-firebase-sign-in-module-ngfactory"],{
...
/* harmony import */ var _angular_fire__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/fire */ "./node_modules/@angular/fire/fesm2015/angular-fire.js");
...
class AngularFireAuth {
    ...
    constructor(options, nameOrConfig, platformId, zone) {
        ...
        /** @type {?} */
        const keepUnstableUntilFirst = Object(_angular_fire__WEBPACK_IMPORTED_MODULE_3__["ɵkeepUnstableUntilFirstFactory"])(schedulers, platformId);
        /** @type {?} */
         ...
         * @return {?}
         */
        app => app.auth())), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["shareReplay"])({ bufferSize: 1, refCount: false }));
        this.authState = auth.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["observeOn"])(schedulers.outsideAngular), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["switchMap"])((/**
         * @param {?} auth
         * @return {?}
         */
        auth => new rxjs__WEBPACK_IMPORTED_MODULE_1__["Observable"](auth.onAuthStateChanged.bind(auth)))), keepUnstableUntilFirst);
        this.user = auth.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["observeOn"])(schedulers.outsideAngular), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["switchMap"])((/**
         * @param {?} auth
         * @return {?}
         */
        auth => new rxjs__WEBPACK_IMPORTED_MODULE_1__["Observable"](auth.onIdTokenChanged.bind(auth)))), keepUnstableUntilFirst);
...
/* harmony import */ var _capacitor_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @capacitor/core */ "./node_modules/capacitor-firebase-auth/node_modules/@capacitor/core/dist/esm/index.js");
...
const cfaSignIn = (providerId, data) => {
    const googleProvider = new firebase_app__WEBPACK_IMPORTED_MODULE_1___default.a.auth.GoogleAuthProvider().providerId;
    const facebookProvider = new firebase_app__WEBPACK_IMPORTED_MODULE_1___default.a.auth.FacebookAuthProvider().providerId;
    const twitterProvider = new firebase_app__WEBPACK_IMPORTED_MODULE_1___default.a.auth.TwitterAuthProvider().providerId;
    const phoneProvider = new firebase_app__WEBPACK_IMPORTED_MODULE_1___default.a.auth.PhoneAuthProvider().providerId;
    switch (providerId) {
        case googleProvider:
...
const cfaSignInGoogle = () => {
    return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](observer => {
        // get the provider id
        const providerId = firebase_app__WEBPACK_IMPORTED_MODULE_1___default.a.auth.GoogleAuthProvider.PROVIDER_ID;
        // native sign in
        plugin.signIn({ providerId }).then((result) => {
            // create the credentials
            const credential = firebase_app__WEBPACK_IMPORTED_MODULE_1___default.a.auth.GoogleAuthProvider.credential(result.idToken);
            // web sign in
            firebase_app__WEBPACK_IMPORTED_MODULE_1___default.a.app().auth().signInWithCredential(credential)
                .then((userCredential) => {
...
const cfaSignInTwitter = () => {
    return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](observer => {
        // get the provider id
        const providerId = firebase_app__WEBPACK_IMPORTED_MODULE_1___default.a.auth.TwitterAuthProvider.PROVIDER_ID;
        // native sign in
        plugin.signIn({ providerId }).then((result) => {
            // create the credentials
            const credential = firebase_app__WEBPACK_IMPORTED_MODULE_1___default.a.auth.TwitterAuthProvider.credential(result.idToken, result.secret);
            // web sign in
            firebase_app__WEBPACK_IMPORTED_MODULE_1___default.a.app().auth().signInWithCredential(credential)
                .then((userCredential) => {
                observer.next(userCredential.user);
...
const cfaSignInFacebook = () => {
    return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](observer => {
        // get the provider id
        const providerId = firebase_app__WEBPACK_IMPORTED_MODULE_1___default.a.auth.FacebookAuthProvider.PROVIDER_ID;
        // native sign in
        plugin.signIn({ providerId }).then((result) => {
            // create the credentials
            const credential = firebase_app__WEBPACK_IMPORTED_MODULE_1___default.a.auth.FacebookAuthProvider.credential(result.idToken);
            // web sign in
            firebase_app__WEBPACK_IMPORTED_MODULE_1___default.a.app().auth().signInWithCredential(credential)
                .then((userCredential) => {
                observer.next(userCredential.user);
...
const cfaSignInPhone = (phone, verificationCode) => {
    return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](observer => {
        // get the provider id
        const providerId = firebase_app__WEBPACK_IMPORTED_MODULE_1___default.a.auth.PhoneAuthProvider.PROVIDER_ID;
        plugin.signIn({ providerId, data: { phone, verificationCode } }).then((result) => {
            ...
            // create the credentials
            const credential = firebase_app__WEBPACK_IMPORTED_MODULE_1___default.a.auth.PhoneAuthProvider.credential(result.verificationId, result.verificationCode);
            // web sign in
            firebase_app__WEBPACK_IMPORTED_MODULE_1___default.a.app().auth().signInWithCredential(credential)
                .then((userCredential) => {
                observer.next(userCredential.user);
...
const cfaSignOut = () => {
    return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](observer => {
        plugin.signOut({}).then(() => {
            // web sign out
            firebase_app__WEBPACK_IMPORTED_MODULE_1___default.a.app().auth().signOut()
                .then(() => {
                observer.next();
                observer.complete();
            })
...
/*!****************************************************************!*\
  !*** ./node_modules/capacitor-firebase-auth/dist/esm/index.js ***!
  \****************************************************************/
/*! exports provided: GoogleSignInResult, TwitterSignInResult, FacebookSignInResult, PhoneSignInResult, cfaSignIn, cfaSignInGoogle, cfaSignInTwitter, cfaSignInFacebook, cfaSignInPhone, cfaSignInPhoneOnCodeSent, cfaSignInPhoneOnCodeReceived, cfaSignOut, mapUserToUserInfo, mapUserCredentialToUserInfo */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _definitions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./definitions */ "./node_modules/capacitor-firebase-auth/dist/esm/definitions.js");
...
/* harmony import */ var _facades__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./facades */ "./node_modules/capacitor-firebase-auth/dist/esm/facades.js");
...
/* harmony import */ var _operators__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./operators */ "./node_modules/capacitor-firebase-auth/dist/esm/operators.js");
...
/* harmony import */ var _web_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./web-runtime */ "./node_modules/capacitor-firebase-auth/node_modules/@capacitor/core/dist/esm/web-runtime.js");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _core_plugin_definitions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./core-plugin-definitions */ "./node_modules/capacitor-firebase-auth/node_modules/@capacitor/core/dist/esm/core-plugin-definitions.js");
...
/* harmony import */ var _global__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./global */ "./node_modules/capacitor-firebase-auth/node_modules/@capacitor/core/dist/esm/global.js");
...
/* harmony import */ var _web_plugins__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./web-plugins */ "./node_modules/capacitor-firebase-auth/node_modules/@capacitor/core/dist/esm/web-plugins.js");
...
/* harmony import */ var _web_index__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./web/index */ "./node_modules/capacitor-firebase-auth/node_modules/@capacitor/core/dist/esm/web/index.js");
...
/* harmony import */ var _global__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./global */ "./node_modules/capacitor-firebase-auth/node_modules/@capacitor/core/dist/esm/global.js");
/* harmony import */ var _web_index__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./web/index */ "./node_modules/capacitor-firebase-auth/node_modules/@capacitor/core/dist/esm/web/index.js");
/* harmony import */ var _web_accessibility__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./web/accessibility */ "./node_modules/capacitor-firebase-auth/node_modules/@capacitor/core/dist/esm/web/accessibility.js");
...
/* harmony import */ var _web_app__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./web/app */ "./node_modules/capacitor-firebase-auth/node_modules/@capacitor/core/dist/esm/web/app.js");
...
/* harmony import */ var _web_browser__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./web/browser */ "./node_modules/capacitor-firebase-auth/node_modules/@capacitor/core/dist/esm/web/browser.js");
...
/* harmony import */ var _web_camera__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./web/camera */ "./node_modules/capacitor-firebase-auth/node_modules/@capacitor/core/dist/esm/web/camera.js");
...
/* harmony import */ var _web_clipboard__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./web/clipboard */ "./node_modules/capacitor-firebase-auth/node_modules/@capacitor/core/dist/esm/web/clipboard.js");
...
/* harmony import */ var _web_filesystem__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./web/filesystem */ "./node_modules/capacitor-firebase-auth/node_modules/@capacitor/core/dist/esm/web/filesystem.js");
...
/* harmony import */ var _web_geolocation__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./web/geolocation */ "./node_modules/capacitor-firebase-auth/node_modules/@capacitor/core/dist/esm/web/geolocation.js");
...
/* harmony import */ var _web_device__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./web/device */ "./node_modules/capacitor-firebase-auth/node_modules/@capacitor/core/dist/esm/web/device.js");
...
/* harmony import */ var _web_local_notifications__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./web/local-notifications */ "./node_modules/capacitor-firebase-auth/node_modules/@capacitor/core/dist/esm/web/local-notifications.js");
...
/* harmony import */ var _web_share__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./web/share */ "./node_modules/capacitor-firebase-auth/node_modules/@capacitor/core/dist/esm/web/share.js");
...
/* harmony import */ var _web_modals__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./web/modals */ "./node_modules/capacitor-firebase-auth/node_modules/@capacitor/core/dist/esm/web/modals.js");
...
/* harmony import */ var _web_motion__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./web/motion */ "./node_modules/capacitor-firebase-auth/node_modules/@capacitor/core/dist/esm/web/motion.js");
...
/* harmony import */ var _web_network__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./web/network */ "./node_modules/capacitor-firebase-auth/node_modules/@capacitor/core/dist/esm/web/network.js");
...
/* harmony import */ var _web_permissions__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./web/permissions */ "./node_modules/capacitor-firebase-auth/node_modules/@capacitor/core/dist/esm/web/permissions.js");
...
/* harmony import */ var _web_splash_screen__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./web/splash-screen */ "./node_modules/capacitor-firebase-auth/node_modules/@capacitor/core/dist/esm/web/splash-screen.js");
...
/* harmony import */ var _web_storage__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./web/storage */ "./node_modules/capacitor-firebase-auth/node_modules/@capacitor/core/dist/esm/web/storage.js");
...
/* harmony import */ var _web_toast__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./web/toast */ "./node_modules/capacitor-firebase-auth/node_modules/@capacitor/core/dist/esm/web/toast.js");
...
/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index */ "./node_modules/capacitor-firebase-auth/node_modules/@capacitor/core/dist/esm/web/index.js");
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index */ "./node_modules/capacitor-firebase-auth/node_modules/@capacitor/core/dist/esm/web/index.js");
/* harmony import */ var _core_plugin_definitions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../core-plugin-definitions */ "./node_modules/capacitor-firebase-auth/node_modules/@capacitor/core/dist/esm/core-plugin-definitions.js");
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index */ "./node_modules/capacitor-firebase-auth/node_modules/@capacitor/core/dist/esm/web/index.js");
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../util */ "./node_modules/capacitor-firebase-auth/node_modules/@capacitor/core/dist/esm/util.js");
...
/* harmony import */ var _angular_fire_auth__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/fire/auth */ "./node_modules/@angular/fire/fesm2015/angular-fire-auth.js");
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm2015/index.js");
...
/* harmony import */ var _profile_firebase_profile_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./profile/firebase-profile.model */ "./src/app/firebase/auth/profile/firebase-profile.model.ts");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/fesm2015/ionic-angular.js");
/* harmony import */ var firebase_app__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! firebase/app */ "./node_modules/firebase/app/dist/index.cjs.js");
/* harmony import */ var firebase_app__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(firebase_app__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var capacitor_firebase_auth__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! capacitor-firebase-auth */ "./node_modules/capacitor-firebase-auth/dist/esm/index.js");
...
class FirebaseAuthService {
    constructor(angularFire, platform) {
        ...
        this.redirectResult = new rxjs__WEBPACK_IMPORTED_MODULE_1__["Subject"]();
    ...
    getProfileDataSource() {
        ...
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(userModel);
    }
    ...
    signOut() {
        if (this.platform.is('capacitor')) {
            return Object(capacitor_firebase_auth__WEBPACK_IMPORTED_MODULE_6__["cfaSignOut"])();
        }
        else {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["from"])(this.angularFire.signOut());
        }
    }
    ...
    socialSignIn(providerName, scopes) {
        if (this.platform.is('capacitor')) {
            return Object(capacitor_firebase_auth__WEBPACK_IMPORTED_MODULE_6__["cfaSignIn"])(providerName);
        }
        else {
            ...
            if (this.platform.is('desktop')) {
                return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["from"])(this.angularFire.signInWithPopup(provider));
            }
            else {
                // web but not desktop, for example mobile PWA
                return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["from"])(this.angularFire.signInWithRedirect(provider));
            }
        }
    }
    signInWithFacebook() {
...
//# sourceMappingURL=default~firebase-auth-firebase-auth-module-ngfactory~firebase-auth-sign-in-firebase-sign-in-module-ngfactory-es2015.js.map