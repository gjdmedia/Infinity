...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~firebase-auth-firebase-auth-module-ngfactory~firebase-auth-sign-in-firebase-sign-in-module-ngfactory"], {
  ...
  /***/
  function node_modulesAngularFireFesm2015AngularFireAuthJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function AngularFireAuth(options, nameOrConfig, platformId, zone) {
      ...
      var keepUnstableUntilFirst = Object(_angular_fire__WEBPACK_IMPORTED_MODULE_3__["ɵkeepUnstableUntilFirstFactory"])(schedulers, platformId);
      /** @type {?} */
      ...
      */
      ...
      function Ye() {
        ...
        return Xe() || !a ? E() : new D(function (c) {
          _b2 = function b() {
            Xe() && (a.removeEventListener("visibilitychange", _b2, !1), c());
          };
  ...
  /***/
  function node_modulesCapacitorFirebaseAuthDistEsmDefinitionsJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorFirebaseAuthDistEsmFacadesJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    /*! rxjs */
    "./node_modules/rxjs/_esm2015/index.js"); // @ts-ignore
    ...
    var cfaSignIn = function cfaSignIn(providerId, data) {
      var googleProvider = new firebase_app__WEBPACK_IMPORTED_MODULE_1___default.a.auth.GoogleAuthProvider().providerId;
      var facebookProvider = new firebase_app__WEBPACK_IMPORTED_MODULE_1___default.a.auth.FacebookAuthProvider().providerId;
      var twitterProvider = new firebase_app__WEBPACK_IMPORTED_MODULE_1___default.a.auth.TwitterAuthProvider().providerId;
      var phoneProvider = new firebase_app__WEBPACK_IMPORTED_MODULE_1___default.a.auth.PhoneAuthProvider().providerId;
    ...
    var cfaSignInGoogle = function cfaSignInGoogle() {
      return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (observer) {
        // get the provider id
        var providerId = firebase_app__WEBPACK_IMPORTED_MODULE_1___default.a.auth.GoogleAuthProvider.PROVIDER_ID; // native sign in

        plugin.signIn({
          providerId: providerId
        }).then(function (result) {
          // create the credentials
          var credential = firebase_app__WEBPACK_IMPORTED_MODULE_1___default.a.auth.GoogleAuthProvider.credential(result.idToken); // web sign in

          firebase_app__WEBPACK_IMPORTED_MODULE_1___default.a.app().auth().signInWithCredential(credential).then(function (userCredential) {
    ...
    var cfaSignInTwitter = function cfaSignInTwitter() {
      return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (observer) {
        // get the provider id
        var providerId = firebase_app__WEBPACK_IMPORTED_MODULE_1___default.a.auth.TwitterAuthProvider.PROVIDER_ID; // native sign in

        plugin.signIn({
          providerId: providerId
        }).then(function (result) {
          // create the credentials
          var credential = firebase_app__WEBPACK_IMPORTED_MODULE_1___default.a.auth.TwitterAuthProvider.credential(result.idToken, result.secret); // web sign in
    ...
    var cfaSignInFacebook = function cfaSignInFacebook() {
      return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (observer) {
        // get the provider id
        var providerId = firebase_app__WEBPACK_IMPORTED_MODULE_1___default.a.auth.FacebookAuthProvider.PROVIDER_ID; // native sign in

        plugin.signIn({
          providerId: providerId
        }).then(function (result) {
          // create the credentials
          var credential = firebase_app__WEBPACK_IMPORTED_MODULE_1___default.a.auth.FacebookAuthProvider.credential(result.idToken); // web sign in
    ...
    var cfaSignInPhone = function cfaSignInPhone(phone, verificationCode) {
      return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (observer) {
        // get the provider id
        var providerId = firebase_app__WEBPACK_IMPORTED_MODULE_1___default.a.auth.PhoneAuthProvider.PROVIDER_ID;
        plugin.signIn({
          providerId: providerId,
          data: {
            phone: phone,
          ...
          var credential = firebase_app__WEBPACK_IMPORTED_MODULE_1___default.a.auth.PhoneAuthProvider.credential(result.verificationId, result.verificationCode); // web sign in
    ...
    var cfaSignOut = function cfaSignOut() {
      return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (observer) {
        plugin.signOut({}).then(function () {
          // web sign out
          firebase_app__WEBPACK_IMPORTED_MODULE_1___default.a.app().auth().signOut().then(function () {
            observer.next();
            observer.complete();
          })["catch"](function (reject) {
            return observer.error(reject);
  ...
  /***/
  function node_modulesCapacitorFirebaseAuthDistEsmIndexJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorFirebaseAuthDistEsmOperatorsJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorFirebaseAuthNode_modulesCapacitorCoreDistEsmCorePluginDefinitionsJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorFirebaseAuthNode_modulesCapacitorCoreDistEsmGlobalJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    /*! ./web-runtime */
    "./node_modules/capacitor-firebase-auth/node_modules/@capacitor/core/dist/esm/web-runtime.js"); // Create our default Capacitor instance, which will be
  ...
  /***/
  function node_modulesCapacitorFirebaseAuthNode_modulesCapacitorCoreDistEsmIndexJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorFirebaseAuthNode_modulesCapacitorCoreDistEsmUtilJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorFirebaseAuthNode_modulesCapacitorCoreDistEsmWebPluginsJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorFirebaseAuthNode_modulesCapacitorCoreDistEsmWebRuntimeJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorFirebaseAuthNode_modulesCapacitorCoreDistEsmWebAccessibilityJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorFirebaseAuthNode_modulesCapacitorCoreDistEsmWebAppJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorFirebaseAuthNode_modulesCapacitorCoreDistEsmWebBrowserJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorFirebaseAuthNode_modulesCapacitorCoreDistEsmWebCameraJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorFirebaseAuthNode_modulesCapacitorCoreDistEsmWebClipboardJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorFirebaseAuthNode_modulesCapacitorCoreDistEsmWebDeviceJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorFirebaseAuthNode_modulesCapacitorCoreDistEsmWebFilesystemJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorFirebaseAuthNode_modulesCapacitorCoreDistEsmWebGeolocationJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorFirebaseAuthNode_modulesCapacitorCoreDistEsmWebIndexJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorFirebaseAuthNode_modulesCapacitorCoreDistEsmWebLocalNotificationsJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorFirebaseAuthNode_modulesCapacitorCoreDistEsmWebModalsJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorFirebaseAuthNode_modulesCapacitorCoreDistEsmWebMotionJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorFirebaseAuthNode_modulesCapacitorCoreDistEsmWebNetworkJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorFirebaseAuthNode_modulesCapacitorCoreDistEsmWebPermissionsJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorFirebaseAuthNode_modulesCapacitorCoreDistEsmWebShareJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorFirebaseAuthNode_modulesCapacitorCoreDistEsmWebSplashScreenJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorFirebaseAuthNode_modulesCapacitorCoreDistEsmWebStorageJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorFirebaseAuthNode_modulesCapacitorCoreDistEsmWebToastJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppFirebaseAuthFirebaseAuthServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _profile_firebase_profile_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    var capacitor_firebase_auth__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    ...
    var FirebaseAuthService = /*#__PURE__*/function () {
      function FirebaseAuthService(angularFire, platform) {
        ...
        if (!this.platform.is('capacitor')) {
          ...
          this.angularFire.getRedirectResult().then(function (result) {
            ...
            if (result.user) {
              _this2.userProviderAdditionalInfo = result.additionalUserInfo.profile;
      ...
      _createClass(FirebaseAuthService, [{
        ...
        value: function getProfileDataSource() {
          var userModel = new _profile_firebase_profile_model__WEBPACK_IMPORTED_MODULE_3__["FirebaseProfileModel"]();
          var provierData = this.currentUser.providerData[0];
          var userData = this.userProviderAdditionalInfo ? this.userProviderAdditionalInfo : provierData; // Default imgs are too small and our app needs a bigger image
        ...
        value: function socialSignIn(providerName, scopes) {
          if (this.platform.is('capacitor')) {
            ...
            var provider = new firebase_app__WEBPACK_IMPORTED_MODULE_5__["auth"].OAuthProvider(providerName);
        ...
        value: function signInWithFacebook() {
          var provider = new firebase_app__WEBPACK_IMPORTED_MODULE_5__["auth"].FacebookAuthProvider();
        ...
        value: function getProfileStore(dataSource) {
          ...
          var shellModel = new _profile_firebase_profile_model__WEBPACK_IMPORTED_MODULE_3__["FirebaseProfileModel"]();
  ...
  /***/
  function srcAppFirebaseAuthProfileFirebaseProfileModelTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
...
//# sourceMappingURL=default~firebase-auth-firebase-auth-module-ngfactory~firebase-auth-sign-in-firebase-sign-in-module-ngfactory-es5.js.map