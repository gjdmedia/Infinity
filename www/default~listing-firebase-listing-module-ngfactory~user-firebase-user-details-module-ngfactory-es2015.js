...
/* harmony import */ var _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/fire/firestore */ "./node_modules/@angular/fire/fesm2015/angular-fire-firestore.js");
...
/* harmony import */ var _crud_listing_firebase_listing_model__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./../crud/listing/firebase-listing.model */ "./src/app/firebase/crud/listing/firebase-listing.model.ts");
/* harmony import */ var _crud_user_firebase_user_model__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./../crud/user/firebase-user.model */ "./src/app/firebase/crud/user/firebase-user.model.ts");
/* harmony import */ var _crud_user_select_image_user_image_model__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./../crud/user/select-image/user-image.model */ "./src/app/firebase/crud/user/select-image/user-image.model.ts");
...
class FirebaseCrudService {
    ...
    */
    getListingDataSource() {
        return this.afs.collection('users').valueChanges({ idField: 'id' })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(actions => actions.map(user => {
    ...
    getListingStore(dataSource) {
        ...
        if (!this.listingDataStore) {
            ...
            const shellModel = [
                new _crud_listing_firebase_listing_model__WEBPACK_IMPORTED_MODULE_5__["FirebaseListingItemModel"](),
                new _crud_listing_firebase_listing_model__WEBPACK_IMPORTED_MODULE_5__["FirebaseListingItemModel"](),
                new _crud_listing_firebase_listing_model__WEBPACK_IMPORTED_MODULE_5__["FirebaseListingItemModel"](),
                new _crud_listing_firebase_listing_model__WEBPACK_IMPORTED_MODULE_5__["FirebaseListingItemModel"](),
                new _crud_listing_firebase_listing_model__WEBPACK_IMPORTED_MODULE_5__["FirebaseListingItemModel"](),
    ...
    searchUsersByAge(lower, upper) {
        ...
        const minDate = (dayjs__WEBPACK_IMPORTED_MODULE_3__(Date.now()).subtract(upper, 'year')).unix();
        const maxDate = (dayjs__WEBPACK_IMPORTED_MODULE_3__(Date.now()).subtract(lower, 'year')).unix();
        const listingCollection = this.afs.collection('users', ref => ref.orderBy('birthdate').startAt(minDate).endAt(maxDate));
        return listingCollection.valueChanges({ idField: 'id' }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(actions => actions.map(user => {
            const age = this.calcUserAge(user.birthdate);
            return Object.assign({ age }, user);
        })));
    }
    ...
    */
    ...
    getCombinedUserDataSource(userId) {
        ...
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["concatMap"])(user => {
            if (user && user.skills) {
                // Map each skill id and get the skill data as an Observable
                const userSkillsObservables = user.skills.map(skill => {
                    return this.getSkill(skill).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["first"])());
                });
                ...
                return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["combineLatest"])([
                    Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(user),
                    Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["forkJoin"])(userSkillsObservables)
                ]).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(([userDetails, userSkills]) => {
    ...
    getCombinedUserStore(dataSource) {
        // Initialize the model specifying that it is a shell model
        const shellModel = new _crud_user_firebase_user_model__WEBPACK_IMPORTED_MODULE_6__["FirebaseCombinedUserModel"]();
        this.combinedUserDataStore = new _shell_data_store__WEBPACK_IMPORTED_MODULE_4__["DataStore"](shellModel);
        // Trigger the loading mechanism (with shell) in the dataStore
    ...
    getRelatedUsersDataSource(combinedUserDataSource) {
        ...
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["filter"])(user => !user.isShell), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["concatMap"])(user => {
            if (user && user.skills) {
    ...
    getRelatedUsersStore(dataSource) {
        ...
        this.relatedUsersDataStore = new _shell_data_store__WEBPACK_IMPORTED_MODULE_4__["DataStore"](shellModel);
        // Trigger the loading mechanism (with shell) in the dataStore
    ...
    */
    ...
    getAvatarsStore(dataSource) {
        ...
        if (!this.avatarsDataStore) {
            // Initialize the model specifying that it is a shell model
            const shellModel = [
                new _crud_user_select_image_user_image_model__WEBPACK_IMPORTED_MODULE_7__["UserImageModel"](),
                new _crud_user_select_image_user_image_model__WEBPACK_IMPORTED_MODULE_7__["UserImageModel"](),
                new _crud_user_select_image_user_image_model__WEBPACK_IMPORTED_MODULE_7__["UserImageModel"](),
                new _crud_user_select_image_user_image_model__WEBPACK_IMPORTED_MODULE_7__["UserImageModel"](),
                new _crud_user_select_image_user_image_model__WEBPACK_IMPORTED_MODULE_7__["UserImageModel"]()
            ];
            this.avatarsDataStore = new _shell_data_store__WEBPACK_IMPORTED_MODULE_4__["DataStore"](shellModel);
            // Trigger the loading mechanism (with shell) in the dataStore
    ...
    */
    ...
    getSkill(skillId) {
        return this.afs.doc('skills/' + skillId)
            .snapshotChanges()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(a => {
    ...
    getUsersWithSameSkill(userId, skills) {
        ...
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["combineLatest"])(queries).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((relatedUsers) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RenderType_SelectUserImageModal", function() { return RenderType_SelectUserImageModal; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "View_SelectUserImageModal_0", function() { return View_SelectUserImageModal_0; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "View_SelectUserImageModal_Host_0", function() { return View_SelectUserImageModal_Host_0; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SelectUserImageModalNgFactory", function() { return SelectUserImageModalNgFactory; });
/* harmony import */ var _styles_select_user_image_modal_scss_shim_ngstyle__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles/select-user-image.modal.scss.shim.ngstyle */ "./src/app/firebase/crud/user/select-image/styles/select-user-image.modal.scss.shim.ngstyle.js");
/* harmony import */ var _styles_select_user_image_shell_scss_shim_ngstyle__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./styles/select-user-image.shell.scss.shim.ngstyle */ "./src/app/firebase/crud/user/select-image/styles/select-user-image.shell.scss.shim.ngstyle.js");
...
/* harmony import */ var _select_user_image_modal__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./select-user-image.modal */ "./src/app/firebase/crud/user/select-image/select-user-image.modal.ts");
/* harmony import */ var _firebase_crud_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../firebase-crud.service */ "./src/app/firebase/crud/firebase-crud.service.ts");
/**
...
/* harmony import */ var _firebase_crud_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../firebase-crud.service */ "./src/app/firebase/crud/firebase-crud.service.ts");
...
//# sourceMappingURL=default~listing-firebase-listing-module-ngfactory~user-firebase-user-details-module-ngfactory-es2015.js.map