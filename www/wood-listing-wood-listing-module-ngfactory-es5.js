...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["wood-listing-wood-listing-module-ngfactory"], {
  /***/
  "./src/app/wood/listing/styles/wood-listing.page.scss.shim.ngstyle.js":
  /*!****************************************************************************!*\
    !*** ./src/app/wood/listing/styles/wood-listing.page.scss.shim.ngstyle.js ***!
    \****************************************************************************/
  ...
  /***/
  function srcAppWoodListingStylesWoodListingPageScssShimNgstyleJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var styles = ["[_nghost-%COMP%] {\n  --page-margin: var(--app-fair-margin);\n  --page-background: var(--app-background);\n  --page-color: #00AFFF;\n}\n\n.listing-item[_ngcontent-%COMP%] {\n  padding: 0px 0px var(--page-margin);\n  background-color: var(--page-background);\n  border-bottom: calc(var(--page-margin) / 2) solid var(--page-color);\n}\n\n.listing-item[_ngcontent-%COMP%]   .image-row[_ngcontent-%COMP%] {\n  --ion-grid-column-padding: 0px;\n}\n\n.listing-item[_ngcontent-%COMP%]   .image-row[_ngcontent-%COMP%]   .item-image[_ngcontent-%COMP%] {\n  cursor: pointer;\n}\n\n.listing-item[_ngcontent-%COMP%]   .image-row[_ngcontent-%COMP%]   .item-image[_ngcontent-%COMP%]:focus {\n  outline: none;\n}\n\n.listing-item[_ngcontent-%COMP%]   .image-row[_ngcontent-%COMP%]   .content-inside-item-image[_ngcontent-%COMP%] {\n  padding: 0px 12%;\n  height: 100%;\n  display: flex;\n  justify-content: center;\n  flex-direction: column;\n}\n\n.listing-item[_ngcontent-%COMP%]   .image-row[_ngcontent-%COMP%]   .content-inside-item-image[_ngcontent-%COMP%]   .item-icon[_ngcontent-%COMP%] {\n  width: 54px;\n  align-self: center;\n  margin-bottom: 24px;\n}\n\n.listing-item[_ngcontent-%COMP%]   .image-row[_ngcontent-%COMP%]   .content-inside-item-image[_ngcontent-%COMP%]   .item-cta[_ngcontent-%COMP%] {\n  margin: 0px auto;\n  padding: calc(var(--page-margin) / 2) calc(var(--page-margin));\n  text-transform: uppercase;\n  font-size: 20px;\n  font-weight: 700;\n  text-align: center;\n  color: var(--ion-color-light);\n  display: flex;\n  align-items: center;\n  background-color: var(--page-color);\n  border-radius: var(--app-fair-radius);\n}\n\n.listing-item[_ngcontent-%COMP%]   .image-row[_ngcontent-%COMP%]   .content-inside-item-image[_ngcontent-%COMP%]   .item-cta[_ngcontent-%COMP%]   .cta-icon[_ngcontent-%COMP%] {\n  font-size: 26px;\n  margin-left: calc(var(--page-margin) / 2);\n}\n\n.listing-item[_ngcontent-%COMP%]   .info-row[_ngcontent-%COMP%] {\n  --ion-grid-column-padding: 0px;\n  padding: var(--page-margin);\n  padding-bottom: calc(var(--page-margin) / 2);\n}\n\n.listing-item[_ngcontent-%COMP%]   .info-row[_ngcontent-%COMP%]   .main-info-col[_ngcontent-%COMP%] {\n  padding-right: calc(var(--page-margin) / 2);\n}\n\n.listing-item[_ngcontent-%COMP%]   .info-row[_ngcontent-%COMP%]   .item-name[_ngcontent-%COMP%] {\n  margin: 0px 0px var(--page-margin);\n  text-transform: capitalize;\n  font-size: 16px;\n}\n\n.listing-item[_ngcontent-%COMP%]   .info-row[_ngcontent-%COMP%]   .item-name[_ngcontent-%COMP%]   .name-anchor[_ngcontent-%COMP%] {\n  color: var(--ion-color-dark);\n  display: block;\n  text-decoration: none;\n}\n\n.listing-item[_ngcontent-%COMP%]   .info-row[_ngcontent-%COMP%]   .item-description[_ngcontent-%COMP%] {\n  margin: 0px 0px calc(var(--page-margin) / 2);\n  color: var(--ion-color-dark-shade);\n  font-size: 14px;\n  line-height: 1.3;\n}\n\n.listing-item[_ngcontent-%COMP%]   .info-row[_ngcontent-%COMP%]   .item-address[_ngcontent-%COMP%] {\n  margin: 0px;\n  color: var(--ion-color-dark-tint);\n  font-size: 12px;\n}\n\n.listing-item[_ngcontent-%COMP%]   .stats-row[_ngcontent-%COMP%] {\n  --ion-grid-column-padding: 0px;\n  padding: 0px var(--page-margin);\n  justify-content: flex-end;\n}\n\n.listing-item[_ngcontent-%COMP%]   .stats-row[_ngcontent-%COMP%]   .stats-icon[_ngcontent-%COMP%] {\n  font-size: 24px;\n}\n\n.listing-item[_ngcontent-%COMP%]   .stats-row[_ngcontent-%COMP%]   .item-rating[_ngcontent-%COMP%] {\n  display: inline-flex;\n  text-align: center;\n  justify-content: flex-end;\n  margin-right: 10px;\n}\n\n.listing-item[_ngcontent-%COMP%]   .stats-row[_ngcontent-%COMP%]   .item-rating[_ngcontent-%COMP%]   .rating-value[_ngcontent-%COMP%] {\n  font-size: 16px;\n  margin-right: 5px;\n  margin: auto;\n}\n\n.listing-item[_ngcontent-%COMP%]   .stats-row[_ngcontent-%COMP%]   .item-reviews[_ngcontent-%COMP%] {\n  display: inline-flex;\n  text-align: center;\n  justify-content: flex-end;\n}\n\n.listing-item[_ngcontent-%COMP%]   .stats-row[_ngcontent-%COMP%]   .item-reviews[_ngcontent-%COMP%]   .reviews-count[_ngcontent-%COMP%] {\n  font-size: 16px;\n  margin-right: 5px;\n  margin: auto;\n}\n/*# sourceMappingURL=data:application/json;base64, */"];
    /***/
  },

  /***/
  "./src/app/wood/listing/styles/wood-listing.shell.scss.shim.ngstyle.js":
  /*!*****************************************************************************!*\
    !*** ./src/app/wood/listing/styles/wood-listing.shell.scss.shim.ngstyle.js ***!
    \*****************************************************************************/
  ...
  /***/
  function srcAppWoodListingStylesWoodListingShellScssShimNgstyleJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var styles = ["[_nghost-%COMP%] {\n  --shell-color: #d9453a;\n  --shell-color-rgb: 0,175,255;\n}\n\napp-image-shell.item-image[_ngcontent-%COMP%] {\n  --image-shell-loading-background: rgba(var(--shell-color-rgb), .10);\n  --image-shell-overlay-background: rgba(var(--ion-color-dark-rgb), .60);\n}\n\napp-image-shell.icon-image[_ngcontent-%COMP%] {\n  --image-shell-loading-background: rgba(var(--shell-color-rgb), .15);\n}\n\n.item-name[_ngcontent-%COMP%]   app-text-shell[_ngcontent-%COMP%] {\n  --text-shell-line-height: 16px;\n  max-width: 70%;\n}\n\n.item-name[_ngcontent-%COMP%]   app-text-shell.text-loaded[_ngcontent-%COMP%] {\n  max-width: unset;\n}\n\n.item-description[_ngcontent-%COMP%]    > app-text-shell[_ngcontent-%COMP%] {\n  --text-shell-line-height: 14px;\n}\n\n.item-address[_ngcontent-%COMP%]    > app-text-shell[_ngcontent-%COMP%] {\n  --text-shell-line-height: 12px;\n  max-width: 60%;\n}\n\n.item-address[_ngcontent-%COMP%]    > app-text-shell.text-loaded[_ngcontent-%COMP%] {\n  max-width: unset;\n}\n\n.rating-value[_ngcontent-%COMP%]    > app-text-shell[_ngcontent-%COMP%] {\n  --text-shell-line-height: 16px;\n  min-width: 30px;\n}\n\n.reviews-count[_ngcontent-%COMP%]    > app-text-shell[_ngcontent-%COMP%] {\n  --text-shell-line-height: 16px;\n  min-width: 30px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"];
    /***/
  },

  /***/
  "./src/app/wood/listing/wood-listing.module.ngfactory.js":
  /*!***************************************************************!*\
    !*** ./src/app/wood/listing/wood-listing.module.ngfactory.js ***!
    \***************************************************************/

  /*! exports provided: woodListingPageModuleNgFactory */

  /***/
  function srcAppWoodListingWoodListingModuleNgfactoryJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "woodListingPageModuleNgFactory", function () {
      return woodListingPageModuleNgFactory;
    });
    /* harmony import */
    ...
    var _wood_listing_module__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./wood-listing.module */
    "./src/app/wood/listing/wood-listing.module.ts");
    /* harmony import */
    ...
    var _wood_listing_page_ngfactory__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./wood-listing.page.ngfactory */
    "./src/app/wood/listing/wood-listing.page.ngfactory.js");
    /* harmony import */
    ...
    var _wood_listing_resolver__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ./wood-listing.resolver */
    "./src/app/wood/listing/wood-listing.resolver.ts");
    /* harmony import */
    ...
    var _wood_listing_page__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
    /*! ./wood-listing.page */
    "./src/app/wood/listing/wood-listing.page.ts");
    /**
     * @fileoverview This file was generated by the Angular template compiler. Do not edit.
     *
     * @suppress {suspiciousCode,uselessCode,missingProperties,missingOverride,checkTypes,extraRequire}
  ...
  /*! exports provided: woodListingPageModule, ɵ0 */

  /***/
  function srcAppWoodListingWoodListingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "woodListingPageModule", function () {
      return woodListingPageModule;
    });
    /* harmony export (binding) */
    ...
    var _wood_listing_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./wood-listing.page */
    "./src/app/wood/listing/wood-listing.page.ts");
    /* harmony import */


    var _wood_listing_resolver__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./wood-listing.resolver */
    "./src/app/wood/listing/wood-listing.resolver.ts");

    var ɵ0 = _wood_listing_resolver__WEBPACK_IMPORTED_MODULE_2__["woodListingResolver"];
    var routes = [{
      path: '',
      component: _wood_listing_page__WEBPACK_IMPORTED_MODULE_1__["woodListingPage"],
      resolve: {
        data: ɵ0
      }
    }];

    var woodListingPageModule = function woodListingPageModule() {
      _classCallCheck(this, woodListingPageModule);
    };
    /***/
  ...
  /*! exports provided: RenderType_woodListingPage, View_woodListingPage_0, View_woodListingPage_Host_0, woodListingPageNgFactory */

  /***/
  function srcAppWoodListingWoodListingPageNgfactoryJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "RenderType_woodListingPage", function () {
      return RenderType_woodListingPage;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "View_woodListingPage_0", function () {
      return View_woodListingPage_0;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "View_woodListingPage_Host_0", function () {
      return View_woodListingPage_Host_0;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "woodListingPageNgFactory", function () {
      return woodListingPageNgFactory;
    });
    /* harmony import */


    var _styles_wood_listing_page_scss_shim_ngstyle__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    /*! ./styles/wood-listing.page.scss.shim.ngstyle */
    "./src/app/wood/listing/styles/wood-listing.page.scss.shim.ngstyle.js");
    /* harmony import */


    var _styles_wood_listing_shell_scss_shim_ngstyle__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./styles/wood-listing.shell.scss.shim.ngstyle */
    "./src/app/wood/listing/styles/wood-listing.shell.scss.shim.ngstyle.js");
    /* harmony import */
    ...
    var _wood_listing_page__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ./wood-listing.page */
    "./src/app/wood/listing/wood-listing.page.ts");
    /**
     * @fileoverview This file was generated by the Angular template compiler. Do not edit.
    ...
    var styles_woodListingPage = [_styles_wood_listing_page_scss_shim_ngstyle__WEBPACK_IMPORTED_MODULE_0__["styles"], _styles_wood_listing_shell_scss_shim_ngstyle__WEBPACK_IMPORTED_MODULE_1__["styles"]];

    var RenderType_woodListingPage = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵcrt"]({
      encapsulation: 0,
      styles: styles_woodListingPage,
      data: {}
    });

    function View_woodListingPage_2(_l) {
      return _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵeld"](0, 0, null, null, 25, "div", [["class", "listing-item"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵeld"](1, 0, null, null, 24, "ion-row", [["class", "image-row"]], null, null, null, _node_modules_ionic_angular_ionic_angular_ngfactory__WEBPACK_IMPORTED_MODULE_3__["View_IonRow_0"], _node_modules_ionic_angular_ionic_angular_ngfactory__WEBPACK_IMPORTED_MODULE_3__["RenderType_IonRow"])), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵdid"](2, 49152, null, 0, _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonRow"], [_angular_core__WEBPACK_IMPORTED_MODULE_2__["ChangeDetectorRef"], _angular_core__WEBPACK_IMPORTED_MODULE_2__["ElementRef"], _angular_core__WEBPACK_IMPORTED_MODULE_2__["NgZone"]], null, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵeld"](3, 0, null, 0, 22, "ion-col", [["size", "12"]], null, null, null, _node_modules_ionic_angular_ionic_angular_ngfactory__WEBPACK_IMPORTED_MODULE_3__["View_IonCol_0"], _node_modules_ionic_angular_ionic_angular_ngfactory__WEBPACK_IMPORTED_MODULE_3__["RenderType_IonCol"])), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵdid"](4, 49152, null, 0, _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonCol"], [_angular_core__WEBPACK_IMPORTED_MODULE_2__["ChangeDetectorRef"], _angular_core__WEBPACK_IMPORTED_MODULE_2__["ElementRef"], _angular_core__WEBPACK_IMPORTED_MODULE_2__["NgZone"]], {
        ...
        var currVal_4 = _ck(_v, 7, 0, "/app/categories/wood/", _v.context.$implicit.slug);
    ...
    function View_woodListingPage_1(_l) {
      return _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵeld"](0, 0, null, null, 2, null, null, null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵand"](16777216, null, null, 1, null, View_woodListingPage_2)), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵdid"](2, 278528, null, 0, _angular_common__WEBPACK_IMPORTED_MODULE_7__["NgForOf"], [_angular_core__WEBPACK_IMPORTED_MODULE_2__["ViewContainerRef"], _angular_core__WEBPACK_IMPORTED_MODULE_2__["TemplateRef"], _angular_core__WEBPACK_IMPORTED_MODULE_2__["IterableDiffers"]], {
        ngForOf: [0, "ngForOf"]
    ...
    function View_woodListingPage_0(_l) {
    ...
    function View_woodListingPage_Host_0(_l) {
      return _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵeld"](0, 0, null, null, 1, "app-wood-listing", [], [[2, "is-shell", null]], null, null, View_woodListingPage_0, RenderType_woodListingPage)), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵdid"](1, 114688, null, 0, _wood_listing_page__WEBPACK_IMPORTED_MODULE_13__["woodListingPage"], [_angular_router__WEBPACK_IMPORTED_MODULE_6__["ActivatedRoute"]], null, null)], function (_ck, _v) {
        _ck(_v, 1, 0);
      }, function (_ck, _v) {
    ...
    var woodListingPageNgFactory = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵccf"]("app-wood-listing", _wood_listing_page__WEBPACK_IMPORTED_MODULE_13__["woodListingPage"], View_woodListingPage_Host_0, {}, {}, []);
    /***/
  ...
  /*! exports provided: woodListingPage */

  /***/
  function srcAppWoodListingWoodListingPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "woodListingPage", function () {
      return woodListingPage;
    });
    /* harmony import */
    ...
    var _wood_listing_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./wood-listing.model */
    "./src/app/wood/listing/wood-listing.model.ts");

    var woodListingPage = /*#__PURE__*/function () {
      function woodListingPage(route) {
        _classCallCheck(this, woodListingPage);

        this.route = route;
      }

      _createClass(woodListingPage, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          ...
          this.subscriptions = this.route.data.subscribe(function (resolvedRouteData) {
            ...
            _this.subscriptions = _utils_resolver_helper__WEBPACK_IMPORTED_MODULE_1__["ResolverHelper"].extractData(resolvedRouteData.data, _wood_listing_model__WEBPACK_IMPORTED_MODULE_2__["woodListingModel"]).subscribe(function (state) {
              _this.listing = state;
            }, function (error) {});
          }, function (error) {});
  ...
  /*! exports provided: woodListingResolver */

  /***/
  function srcAppWoodListingWoodListingResolverTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "woodListingResolver", function () {
      return woodListingResolver;
    });
    /* harmony import */


    var _wood_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    /*! ../wood.service */
    "./src/app/wood/wood.service.ts");

    var woodListingResolver = /*#__PURE__*/function () {
      function woodListingResolver(woodService) {
        _classCallCheck(this, woodListingResolver);

        this.woodService = woodService;
      }

      _createClass(woodListingResolver, [{
        key: "resolve",
        value: function resolve() {
          var dataSource = this.woodService.getListingDataSource();
          var dataStore = this.woodService.getListingStore(dataSource);
          return dataStore;
        }
      }]);
...
//# sourceMappingURL=wood-listing-wood-listing-module-ngfactory-es5.js.map