...
const Nav = class {
    ...
    async componentDidLoad() {
        this.rootChanged();
        this.gesture = (await __webpack_require__.e(/*! import() | swipe-back-7b4b8b66-js */ "swipe-back-7b4b8b66-js").then(__webpack_require__.bind(null, /*! ./swipe-back-7b4b8b66.js */ "Lzhg"))).createSwipeBackGesture(this.el, this.canStart.bind(this), this.onStart.bind(this), this.onMove.bind(this), this.onEnd.bind(this));
