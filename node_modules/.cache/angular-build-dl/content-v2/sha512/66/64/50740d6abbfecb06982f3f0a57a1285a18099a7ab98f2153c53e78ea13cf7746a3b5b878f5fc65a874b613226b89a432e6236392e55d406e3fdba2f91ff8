...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["firebase-auth-firebase-auth-module-ngfactory"], {
  ...
  /***/
  function srcAppFirebaseAuthFirebaseAuthModuleNgfactoryJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppFirebaseAuthFirebaseAuthModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var ɵ0 = function ɵ0() {
      ...
      "./src/app/firebase/auth/sign-in/firebase-sign-in.module.ngfactory.js")).then(function (m) {
      ...
      "./src/app/firebase/auth/sign-up/firebase-sign-up.module.ngfactory.js")).then(function (m) {
      ...
      "./src/app/firebase/auth/profile/firebase-profile.module.ngfactory.js")).then(function (m) {
